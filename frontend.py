...
manageFrame.grid(row=0,column=0,sticky="w",padx=[10,10],pady=20,ipadx=[6])
...
exportBtn=Button(manageFrame,text="EXPORT EXCEL",width=12,borderwidth=3,bg=btnColor,fg='black',command=exportExcel)

saveBtn.grid(row=0,column=0,padx=5,pady=10)
updateBtn.grid(row=0,column=1,padx=5,pady=10)
deleteBtn.grid(row=0,column=2,padx=5,pady=10)
selectBtn.grid(row=0,column=3,padx=5,pady=10)
findBtn.grid(row=0,column=4,padx=5,pady=10)
clearBtn.grid(row=0,column=5,padx=5,pady=10)
exportBtn.grid(row=0,column=6,padx=5,pady=10)
...
itemIdEntry=Entry(entriesFrame,width=40,textvariable=placeholderArray[0])
nameEntry=Entry(entriesFrame,width=40,textvariable=placeholderArray[1])
priceEntry=Entry(entriesFrame,width=40,textvariable=placeholderArray[2])
qntEntry=Entry(entriesFrame,width=40,textvariable=placeholderArray[3])
categoryCombo=ttk.Combobox(entriesFrame,width=37,textvariable=placeholderArray[4],values=categoryArray)

itemIdEntry.grid(row=0,column=2,padx=5,pady=2)
nameEntry.grid(row=1,column=2,padx=5,pady=2)
priceEntry.grid(row=2,column=2,padx=5,pady=2)
qntEntry.grid(row=3,column=2,padx=5,pady=2)
categoryCombo.grid(row=4,column=2,padx=5,pady=2)

generateIdBtn=Button(entriesFrame,text="GENERATE ID",borderwidth=3,bg='#196E78',fg='black',command=generateRand)
generateIdBtn.grid(row=0,column=3,padx=5,pady=(0,5),sticky='w')
